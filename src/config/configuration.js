...
const aws_secrets_service_1 = require("./aws-secrets.service");
async function getConfigValues() {
    ...
    try {
        const awsSecretsService = new aws_secrets_service_1.AwsSecretsService();
        ...
        return {
            ...
            fileUpload: {
                provider: secrets.FILE_UPLOAD_PROVIDER || '',
            },
        };
    }
    catch (error) {
